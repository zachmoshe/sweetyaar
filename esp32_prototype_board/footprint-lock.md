...
| `JP1` | 5 V source select | 1x3 2.54 mm vertical header plus shunt | Hand-solder | `Connector_PinHeader_2.54mm:PinHeader_1x03_P2.54mm_Vertical` | Low | Locked as hand-soldered. Use one removable 2.54 mm shunt to select USB 5 V or external 5 V. |
...
| `SJ1` | GPIO2 LED disconnect | Bare solder jumper | PCB only | `Jumper:SolderJumper-2_P1.3mm_Open_TrianglePad1.0x1.5mm` | Low | Locked. No BOM part. Default open is appropriate for GPIO2 strap safety. |
...
| `C3`, `C4`, `C5`, `C8`, `C10`, `C13` | 100 nF decoupling | Yageo `CC0805KRX7R9BB104`, JLC/LCSC `C49678`, 100nF 50V X7R 0805 | Basic | `Capacitor_SMD:C_0805_2012Metric` | Low | Locked. Use this one 100 nF part everywhere. |
